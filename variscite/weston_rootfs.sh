...
#		tar -xpf ${LPARAM_OUTPUT_DIR}/${DEF_ROOTFS_TARBALL_NAME} -C ${P1_MOUNT_DIR}/
		pv ${LPARAM_OUTPUT_DIR}/${DEF_ROOTFS_TARBALL_NAME} | tar -xz -C ${P1_MOUNT_DIR}/
	}
...
#		cp ${LPARAM_OUTPUT_DIR}/${DEF_ROOTFS_TARBALL_NAME} \
		pv ${LPARAM_OUTPUT_DIR}/${DEF_ROOTFS_TARBALL_NAME} > \
